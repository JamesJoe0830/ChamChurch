        ...
        <ContentsBoxDiv>
          <CurchExplainDiv>
            ...
            <ChurchContents>
              ...
              <p>- 참조은 교회의 사명은 주님의 지상명령을 수행하며 깊은 곳에 가서
              그물을 내려 복음을 전하며 가르쳐 지키게 함에 있습니다(마태복음
              28:19~20).</p> <p>- 참조은 교회는 주님이 웃음 지음을 목적하는 선교적
              교회이며 성도들이 하나님 말씀을 배우며, 삶으로 응답하는 삶을
              추구합니다.</p> <p>- 참 좋은 교회는 하나님이 웃음 지음을 목적하는 선교적
              교회입니다.</p> <p>- 참 좋은 교회는 수원 제일 교회나 창훈대교회와 같은 대한
              예수교장로회(합동) 소속이며 수원노회에 가입되어 있습니다</p>
            </ChurchContents>
            <SloganDiv>
              SMILE
            </SloganDiv>
