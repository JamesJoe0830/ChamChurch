...
function Kakao() {
  ...
  var markerPosition  = new kakao.maps.LatLng(37.27680826575521, 127.0412322006258); 
  var marker = new kakao.maps.Marker({
    position: markerPosition
});
marker.setMap(map);
var iwContent = '<div style="padding:5px;">참조은 교회 <br><a href="https://map.kakao.com/link/map/참조은 교회,37.27680826575521,127.0412322006258" style="color:blue" target="_blank">큰지도보기</a> <a href="https://map.kakao.com/link/to/참조은 교회,37.27680826575521,127.0412322006258" style="color:blue" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
